      ...
      <div id="PluginContainer">
        ...
        <div id="AppControls">
          <div className="container mt-3">
            <div id="app">
              <div id="lblExplanation">
                Select a region to start and view projects
              </div>
              <div id="region-selector">
                ...
                <label
                  ...
                  onClick={handleRegionSelectChange.bind(this)}
                >
                  EU
                </label>
                <label
        ...
        <div id="NoAccess" hidden>
          ...
          <div>
            ...
            FormIt-Forma plugin needs to save data to the local storage, so it
            can only be used in standard browsing mode.
            <br />
            <br />
            To use FormIt Plugin Facade, please switch to standard browsing
            mode.
          </div>
        </div>
      </div>
